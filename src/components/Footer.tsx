      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="mt-6">
              <h4 className="font-serif text-base font-medium mb-2 text-mudra-primary">Certifications</h4>
              <div className="flex items-center space-x-4">
                {/* Placeholder for certification logos */}
                <div className="bg-gray-100 rounded-md p-2 h-12 w-24 flex items-center justify-center text-xs text-gray-500">
                  Certification 1
                </div>
                <div className="bg-gray-100 rounded-md p-2 h-12 w-24 flex items-center justify-center text-xs text-gray-500">
                  Certification 2
          ...
          <div>
            ...
            <form className="space-y-2">
              ...
              <button
                type="submit"
                className="w-full px-4 py-2 bg-mudra-primary text-white rounded-md hover:bg-mudra-secondary transition-colors"
              >
                Subscribe
              </button>
            </form>
