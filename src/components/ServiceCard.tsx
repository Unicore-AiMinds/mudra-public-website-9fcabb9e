...
const ServiceCard = ({ title, description, icon, image, theme = 'mudra', animationDelay = 0 }: ServiceCardProps) => {
  ...
  return (
    <div 
      className={`service-card-reveal relative h-full bg-white rounded-xl overflow-hidden transition-all duration-300 hover:scale-[1.03] ${
        theme === 'meditouch' 
    ...
    >
      ...
      {theme === 'meditouch' || theme === 'dental' ? (
        ...
        // Original Vertical Layout for other themes
        <>
          {image && (
